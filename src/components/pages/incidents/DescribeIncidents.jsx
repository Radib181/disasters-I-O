      ...
      <div className="flex flex-col justify-center items-center my-10 gap-8">
        <div className="md:w-1/2 w-[90%] flex flex-col gap-4">
          ...
          <input
            ...
            className="bg-whiteLight border border-gray-300 px-6 py-4 rounded-lg w-full focus:outline-none focus:shadow-inner focus:shadow-green-300 transition-all duration-300 text-[12px]"
          />
        </div>
        <div className="md:w-1/2 w-[90%] flex flex-col gap-4">
          <div>
          ...
          <textarea
            ...
            className="bg-whiteLight border border-gray-300 px-4 py-2 rounded-lg w-full h-32 focus:outline-none focus:shadow-inner focus:shadow-green-300 transition-all duration-300 text-[12px]"
          ></textarea>
        </div>
      </div>
    </div>
